...
\begin{itemize}
  ...
  \item Lastly, the exploitation of the expressions' hierarchical representation structure, which is employed to mitigate the expression swelling, as a set of index-1 variables in a newly developed numerical scheme for the integration of reduced-index \acp{DAE}.
\end{itemize}
%
