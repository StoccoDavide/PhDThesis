...
\end{enumerate}
%
Notably, in the application example~\ref{chap5:enum:suspension}, the sub-models and techniques used for both tire-ground interaction and model reduction are those presented in Appendices~\ref{app1:acme}, \ref{app2:enve}, \ref{app3:tirex}, and \ref{app4:trussme}.
...
\begin{equation*}
  \begin{cases}
    ...
    \bm{\Phi}(\m{q}_{r}) = \m{0}
  \end{cases} \, \text{,}
  \quad \text{with} \quad \jac{\bm{\Phi}}{\m{q}_{r},\m{q}_{f}}(\m{q}_{r}, \m{q}_{f}^{\phantom{\prime}}, t) = \dfrac{\partial\bm{\Phi}(\m{q}_{r}, \m{q}_{f}^{\phantom{\prime}}, t)}{\partial(\m{q}_{r}, \m{q}_{f}^{\phantom{\prime}})}
  \, \text{,}
\end{equation*}
%
...
\begin{table}
  ...
  {\footnotesize\begin{tabular}{cccc}
    ...
    \midrule
    \textbf{Reduced \acp{DAE}} & \multicolumn{3}{c}{$\mFv = (0.3\cf + 1.5\cm + 0.1\ca)\cdot10^{6} + 1308\cv + 2330\cd$ \quad $\mhv = 44\cf + 6\cv + 2\cd + 97\cm + 28\ca$} \\
    \bottomrule \\[0.5em]
  \end{tabular}
  }}
