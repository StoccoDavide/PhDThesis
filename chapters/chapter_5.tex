...
%
\begin{equation}
  \dfrac{\de{}}{\de{} t}\bm{\Phi}(\m{q}, t) = \jac{\bm{\Phi}}{\m{q}}(\m{q}, t) \m{p} + \jac{\bm{\Phi}}{t}(\m{q}, t) = \m{0}
  \, \text{,}
...
%
\begin{equation}
  \dfrac{\de{}^2}{\de{}t^2}\bm{\Phi}(\m{q}, t) = \hes{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{p} + \jac{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{p}^{\prime} + \dif{\bm{\Phi}}{tt}(\m{q}, t) = \m{0} \, \text{,}
...
\begin{equation*}
  ...
  \quad \text{and} \quad
  \hes{\bm{\Phi}}{\m{q}}(\m{q}, t) = \dfrac{\de{}}{\de{} t}\,\jac{\bm{\Phi}}{\m{q}}(\m{q}, t) \, \text{,}
\end{equation*}
%
...
\begin{equation}
  \begin{cases}
    \m{q}^{\prime} = \m{p} \\
    \m{M}(\m{q}, \m{p}, t)\m{p}^{\prime} - \jac{\bm{\Phi}}{\m{q}}(\m{q}, t)^{\top}\bm{\lambda} = \m{f}(\m{q},\m{p},t) \\
    -\jac{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{p}^{\prime} = \hes{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{p} + \dif{\bm{\Phi}}{tt}(\m{q}, t)
  \end{cases} \, \text{.}
...
\begin{equation}
  ...
  \begin{bmatrix}
    \m{p} \\
    \m{f}(\m{q},\m{p},t) \\
    \hes{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{p} + \dif{\bm{\Phi}}{tt}(\m{q}, t)
  \end{bmatrix} \, \text{.}
\end{equation}
%
...
%
\begin{align*}
  \hes{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{p} &+ \jac{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{M}(\m{q}, \m{q}^{\prime}, t)^{-1} \jac{\bm{\Phi}}{\m{q}}(\m{q}, t)^{\top}\bm{\lambda} \dots \\
...
\begin{align*}
  ...
  &\Big(\hes{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{p} + \jac{\bm{\Phi}}{\m{q}}(\m{q}, t)\m{M}(\m{q}, \m{q}^{\prime}, t)^{-1}\m{f}(\m{q},\m{p},t) + \dif{\bm{\Phi}}{tt}(\m{q}, t)\Big) \, \text{,}
\end{align*}
%
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=8.0cm]{figures/chapter_5/car_axis}
...
%
\begin{align*}
  \m{M}_e&(\m{q}_{r}, \m{q}_{f}^{\phantom{\prime}}) = \\
  &\begin{bmatrix}
...
\begin{equation*}
  \m{f}(\m{q}_{r}, \m{q}_{f}^{\phantom{\prime}}, \m{q}_{r}^\prime, \m{q}_{f}^\prime) = \begin{bmatrix}
    ...
    \m{f}_{d}(\m{q}_{r}, \m{q}_{f}^{\phantom{\prime}}, \m{q}_{r}^\prime, \m{q}_{f}^\prime) - \nabla\m{W}_{d}(\m{q}_{f}^{\phantom{\prime}}) - \m{D}_{d} \m{q}_{f}^\prime
  \end{bmatrix} \, \text{.}
\end{equation*}
%
...
%
\begin{align*}
  \m{f}_e&(\m{q}_{r}, \m{q}_{f}^{\phantom{\prime}}, \m{q}_{r}^\prime, \m{q}_{f}^\prime) = \\
  &\begin{bmatrix}
...
The gradient of the elastic potential $\m{W}_{d}(\m{q}_{f}^{\phantom{\prime}})$ in case of linear elasticity is $\nabla\m{W}_{d}(\m{q}_{f}^{\phantom{\prime}}) = \m{K}_{d} \m{q}_{f}^{\phantom{\prime}}$ with the stiffness matrix
%
\begin{equation*}
...
\end{equation*}
%
Alternatively, in the case of the nonlinear beam model, it holds $\nabla\m{W}_{d}(\m{q}_{f}^{\phantom{\prime}}) = \m{K}_{d}\m{q}_{f}^{\phantom{\prime}} + \m{K}_{d}(\m{q}_{f}^{\phantom{\prime}})$, where
%
\begin{equation*}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=6.45cm]{figures/chapter_5/flexible_slider_crank}
  \caption{Representation of the flexible slider-crank mechanism~\cite{lioen1998test, mazzia2008test}.}
  \label{chap5:fig:flexible_slider_crank_scheme}
\end{figure}
...
\begin{sidewaystable}[htbp]
  ...
  \centering
  \setlength{\tabcolsep}{0.35em} % TO FIT TABLE INTO TEXT WIDTH
  \small{\begin{tabular}{cccc}
    \multicolumn{4}{c}{\textbf{Flexible Slider-Crank Mechanism}~\cite{lioen1998test, mazzia2008test}} \\
    \toprule
...
\begin{figure}[htb]
  ...
  \begin{minipage}[c]{0.425\linewidth}
    \centering
    \setlength{\tabcolsep}{0.3em} % TO FIT TABLE INTO TEXT WIDTH
    \small{\begin{tabular}{ccc}
      \toprule
      \multirow{2}{*}{\textbf{\#}} & \multirow{2}{*}{\textbf{Component}} & \textbf{\TrussMe{}} \\
      & & \textbf{type} \\
      \midrule
      \circled{\small{1}} & Carbon fiber cell & Rigid support    \\[0.2em]
      \circled{\small{2}} & Shock absorber    & Constrained node \\[0.2em]
      \circled{\small{3}} & Rocker            & Generic element  \\[0.2em]
      \circled{\small{4}} & Push rod          & Rod element      \\[0.2em]
      \circled{\small{5}} & Tie rod           & Rod element      \\[0.2em]
      \circled{\small{6}} & Wheel carrier     & Generic element  \\[0.2em]
      \circled{\small{7}} & Upper wishbone    & Beam elements    \\[0.2em]
      \circled{\small{8}} & Lower wishbone    & Beam elements    \\[0.2em]
...
\begin{minipage}[t]{0.485\linewidth}
  ...
  \centering
  \setlength{\tabcolsep}{0.4em} % TO FIT TABLE INTO TEXT WIDTH
  \small{\begin{tabular}{ccc}
    \toprule
...
\begin{equation}
  \begin{system}
  H{\,}^{\prime}   &=& V_r\sin(\gamma) \\[0.1em]
  \xi^{\prime}     &=& \dfrac{V_r\cos(\gamma) \sin(A)}{r \cos(\lambda)} \\[0.1em]
  \lambda^{\prime} &=& \dfrac{V_r}{r} \cos(\gamma) \cos(A) \\[0.1em]
  V{\,}^{\prime}_r &=& -\dfrac{D}{m} - g\sin(\gamma) - \Omega_e^2 r \cos(\lambda)(\sin(\lambda) \cos(A) \cos(\gamma)-\cos(\lambda) \sin(\gamma)) \\[0.1em]
  \gamma^{\prime}  &=& \dfrac{L\cos(\beta)}{m V_r}+\dfrac{\cos(\gamma)}{V_r}\left(\dfrac{V_r^2}{r}-g\right) + 2\Omega_e \cos(\lambda) \sin(A)\dots \\[0.1em]
                   & & +\dfrac{\Omega_e^2 r \cos(\lambda)}{V_r}(\sin(\lambda) \cos(A) \sin(\gamma)+\cos(\lambda) \cos(\gamma)) \\[0.1em]
  A{\,}^{\prime}       &=& \dfrac{L\sin(\beta)}{m V_r \cos(\gamma)}+\dfrac{V_r}{r} \cos(\gamma) \sin(A) \tan(\lambda) \dots \\[0.1em]
                   & & - 2\Omega_e(\cos(\lambda) \cos(A) \tan(\gamma) - \sin(\lambda)) + \dfrac{\Omega_e^2 r \cos(\lambda) \sin(\lambda) \sin(A)}{V_r \cos(\gamma)}
  \end{system} \, \text{,}
...
\begin{equation*}
  \begin{system}
    ...
    x_5^{\prime} &=& 2c(x_3)(x_4+x_6)^2 - x_4^2d(x_3) + (2 x_3-x_2)(1-3a(x_3)-2b(x_3)) \dots \\
                 & & -a(x_3)(u_1-u_2) + u_2 \\
    x_6^{\prime} &=& 2c(x_3)(x_4+x_6)^2 - x_4^2d(x_3) + (2 x_3-x_2)(a(x_3)-9b(x_3)) \dots \\
                 & & -(a(x_3)+b(x_3))(u_1-u_2) - d(x_3)(x_4+x_6)^2 - 2x_4^2c(x_3) \\
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=6.0cm]{figures/chapter_5/robotic_arm.eps}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=9.0cm]{figures/chapter_5/transistor_amplifier.eps}
  \caption{Eight-node transistor-amplifier circuit~\cite{lioen1998test, mazzia2008test}.}
  \label{chap5:fig:transistor_amplifier}
\end{figure}

The index reduction process is performed smoothly, and the complexity of the expressions encountered throughout the index reduction is detailed in Table~\ref{chap5:tab:transistor_amplifier_results}. As we can see, the expression complexity is not affected by the index reduction process. The numerical integration of the reduced \ac{DAE} system is carried out using both the \Maple{} and \Indigo{} numerical solvers. In this regard, \Maple{}, \Mathematica{}, \Matlab{} (both Pantelides and Gaussian elimination), and \Indigo{} can integrate the original \ac{DAE} system in the specified time interval $t \in \RSI{0}{0.2}{\second}$.
...
\begin{sidewaystable}[htbp]
  ...
  \label{chap5:tab:transistor_amplifier_results}
  \centering
  \small{\begin{tabular}{cccc}
  ...
  \label{chap5:tab:ring_modulator}
  \centering
  \small{\begin{tabular}{cccc}
...
\end{equation*}
%
with $\ma = [- x_1 - C_1 R_1 U{\,}^{\prime}(t)]$. Then the index reduction is performed $p$ times, and the system $\mE \, \mxp = \mg$ at the $k$-th index reduction step is equal to
%
\begin{equation*}
  \arraycolsep=3pt
