...
\begin{equation}
  ...
  \cos(\theta) = \dfrac{1 - u^2}{1 + u^2} \, text{,} \quad
  \sin(\theta) = \dfrac{2u}{1 + u^2} \, text{,}
  \qquad \text{where} \qquad
  u = \tan\left(\dfrac{\theta}{2}\right) \, text{.}
\end{equation}
%
...
\subsection[The Full-Pivoting LU Factorization]{The Full-Pivoting Lower-Upper Factorization}
...
\subsubsection{The LU Factorization from a Numerical Computation Point of View}
