...
\begin{footnotesize}
  \begin{equation*}
    x(t) = \begin{cases}
      \dfrac{t^2}{2} & 0\leq t\leq 1 \\[0.5em]
      \dfrac{1}{4} \left(-t^2+6 t-3\right) & 1<t\leq 2 \\[0.5em]
      -\dfrac{3 t^2}{8}+2 t-\dfrac{5}{4} & 2<t\leq 3 \\[0.5em]
      \dfrac{1}{16} \left(-t^2+2 t+25\right) & 3<t\leq 4 \\[0.5em]
      \dfrac{1}{32} \left(5 t^2-52 t+162\right) & 4<t\leq 5 \\[0.5em]
      \dfrac{1}{64} \left(7 t^2-74 t+249\right) & 5<t\leq 6 \\[0.5em]
      \dfrac{1}{128} \left(-3 t^2+56 t-114\right) & 6<t\leq 7 \\[0.5em]
      \dfrac{1}{256} \left(-17 t^2+266 t-767\right) & 7<t\leq 8 \\[0.5em]
      \dfrac{1}{512} \left(-11 t^2+164 t-62\right) & 8<t\leq 9 \\[0.5em]
      \dfrac{23 t^2-482 t+3521}{1024} & 9<t\leq 10 \\[0.5em]
      \dfrac{45 t^2-944 t+6942}{2048} & 10<t\leq 11 \\[0.5em]
      \dfrac{-t^2+114 t+2873}{4096} & 11<t\leq 12 \\[0.5em]
      \dfrac{-91 t^2+2364 t-7070}{8192} & 12<t\leq 13 \\[0.5em]
      \dfrac{-89 t^2+2310 t+1577}{16384} & 13<t\leq 14 \\[0.5em]
      \dfrac{93 t^2-2968 t+56270}{32768} & 14<t\leq 15
    \end{cases} \, \text{,}
    \quad \text{and} \quad u(t) = \begin{cases}
      1 & 0\leq t\leq 1 \\[0.5em]
      -\dfrac{1}{2} & 1<t\leq 2 \\[0.5em]
      -\dfrac{3}{4} & 2<t\leq 3 \\[0.5em]
      -\dfrac{1}{8} & 3<t\leq 4 \\[0.5em]
      \dfrac{5}{16} & 4<t\leq 5 \\[0.5em]
      \dfrac{7}{32} & 5<t\leq 6 \\[0.5em]
      -\dfrac{3}{64} & 6<t\leq 7 \\[0.5em]
      -\dfrac{17}{128} & 7<t\leq 8 \\[0.5em]
      -\dfrac{11}{256} & 8<t\leq 9 \\[0.5em]
      \dfrac{23}{512} & 9<t\leq 10 \\[0.5em]
      \dfrac{45}{1024} & 10<t\leq 11 \\[0.5em]
      -\dfrac{1}{2048} & 11<t\leq 12 \\[0.5em]
      -\dfrac{91}{4096} & 12<t\leq 13 \\[0.5em]
      -\dfrac{89}{8192} & 13<t\leq 14 \\[0.5em]
...
\pagebreak % FIXME: Remove this line
  ...
  \begin{algorithmic}[1]
    ...
    \For{$i$ \textbf{from} $k$ \textbf{to} $m$} \Comment{Iterate over the rows}
      \For{$j$ \textbf{from} $k$ \textbf{to} $n$} \Comment{Iterate over the columns}
        ...
        \IfThen{$A_{ij} \neq 0$}
        {$D_{ij} \gets d^r_{i} \, \max(0, \, d^c_j-1) + d^c_j \, \max(0, \, d^r_i-1)$} \Comment{The degree}
      \EndFor
    \EndFor
    ...
    \State $p, \, p_c, \, p_n \gets \infty, \, \infty, \, \infty$ \Comment{Initialize the pivot value, complexity and numerical value}
    \For{\textbf{all} $(i, j)$ \textbf{in} $\mathcal{P}$} \Comment{Iterate on the permutation set}
      ...
      \If{$t_c < p_c$ \textbf{or} ($t_c = p_c$ \textbf{and} $t_n > p_n$)} \Comment{If the pivot is better than the current one}
        ...
        \State $p, \, p_c, \, p_n \gets t, \, t_c, \, t_n$ \Comment{Save the best pivot value, complexity and numerical value}
      \EndIf
    \EndFor \\
