...
%A \ac{CAS} is a specialized software designed to execute symbolic mathematical operations. As a result, it possesses the capability to execute precise symbolic computations across various mathematical domains. Some of these capabilities include but are not limited to the following operations.
%
%\begin{itemize}
