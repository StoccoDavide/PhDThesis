...
\setallmainfonts[Numbers={Lining,Proportional}]{Adobe Caslon Pro} %PFDINSerif} % normal document font
\setallsansfonts[Scale=1.0]{HvDTrial Brandon Grotesque} %DIN Alternate} % sans-serif font (\textsf{})
...
%
\begin{itemize}
  \item \fullcite{stocco2021acme} -  Reproduced with permission from Elsevier.
  \item \fullcite{stocco2024symbolic} -  Reproduced with permission from Springer.
  \item \fullcite{stocco2024matrix} -  Reproduced with permission from Elsevier.
  \item \fullcite{stocco2024novel} -  Reproduced with permission from ASME.
  \item \fullcite{stocco2024physical} -  Reproduced with permission from Elsevier.
\end{itemize}
...
\begin{multicols}{2}
  \begin{acronym}[XXXXXXXX]
    ...
    \acro{TP-BVP}{Two-Point Boundary Value Problem}
