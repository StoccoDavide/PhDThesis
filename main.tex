...
\setallsansfonts[Scale=1.0]{HvDTrial Brandon Grotesque}      % Optima % sans-serif font (\textsf{})
...
{\chapter}                       % command
[display]                        % shape
{\sffamily\center\Huge\bfseries}      % format
{\MakeUppercase{\chaptertitlename}\quad\MakeUppercase{\thechapter}\\[0.5ex]$\cdot\cdot\cdot$} % label
{0.5ex}                           % sep
{\Huge\MakeUppercase}[\vspace{2ex}]  % before-code
