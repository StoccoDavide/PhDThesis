\documentclass[a5paper, 9pt, openright]{extbook} % book template, paper size is b5
...
\usepackage[nohyperlinks]{acronym} % to define abbreviations
...
\usepackage{csquotes}             % to write quotes in the document (required by babel)
...
\usepackage[
  hidelinks, % remove the boxes around the links
  colorlinks  = false, %true,
  linkcolor   = black,
  urlcolor    = black, %blue_ncs,
  citecolor   = black, %blue_ncs,
  anchorcolor = black
...
%\newgeometry{top=2.5cm, bottom=2.0cm, width=10.8cm, bindingoffset=0.0cm} % print version
...
\newcommand{\mywarnmark}{\textcolor{mycolor3}{{\footnotesize\faExclamationTriangle}}}
...
\newcommand{\hes}[2]{\ensuremath{\dot{#1}_{#2}}}
...
% Copyright --------------------------------------------------------------------
\usepackage[
  type     = {CC},       % Creative Commons license
  modifier = {by-nc-nd}, % Attribution-NonCommercial-NoDerivatives
  version  = {4.0},      % Version 4.0 International
]{doclicense}
